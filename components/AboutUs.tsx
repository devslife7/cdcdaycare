...
export default function AboutUs({ dictionary }: { dictionary: any }) {
  return (
    <section id="about-us" className="py-5 lg:py-24">
      <FadeIn className="my-container grid justify-center mt-10 lg:grid-cols-2 gap-16">
        <div className="space-y-6 max-w-2xl mx-auto">
          <h2 className="text-purple text-3xl lg:text-5xl relative">
            {dictionary.title}
            <span className="absolute left-0 top-2">___</span>
          </h2>

          <p className="lg:text-lg font-[250] leading-relaxed lg:leading-8 text-purple-950">{dictionary.subtitle1}</p>
