...
export default function Philosophy({ dictionary }: { dictionary: any }) {
  return (
    <section id="philosophy" className="bg-secondary py-10 lg:py-24 text-white">
      <FadeIn className="my-container grid lg:grid-cols-2 gap-16 justify-center">
        <div className="max-w-2xl space-y-6 lg:px-4 mx-auto bg-pink-400">
          <h2 className="text-primary text-3xl lg:text-5xl mt-8 relative">
            {dictionary.title}
            <span className=" absolute left-0 top-2">___</span>
          </h2>
          <p className="lg:text-lg font-extralight leading-loose bg-blue-400 text-primary-100">{dictionary.subtitle}</p>
        </div>
